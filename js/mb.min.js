/*! MunshiBaba app.js
* ================
* Main JS application file for Munshi Baba v1.0 This file
* should be included in all pages. It controls some layout
* options and implements exclusive MunshiBaba plugins.
*
* @Author  Munshi Baba
* @Support <https://www.munshibaba.com>
* @Email   <maqsood@munshibaba.com>
* @version 1.0
* @repository git://github.com/munshibaba/mb.git
