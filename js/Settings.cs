...
";
    ...
    public string UpdateGroupLicenseStatus(string email)
    {
        ...
        if (arg[0].Length == 36)
        {
            ...
            body1 = body1 + "<br/><a href='http://beta.munshibaba.com/GroupLicenseAccept.html?token=" + arg[0] + "'> Click Here to Accept </a> <br/>";
            body1 = body1 + "";
    ...
    [WebMethod]
    public string SwitchLevelInvite(string SwitchID, string email)
    {
        ...
        //if (cal.Length == 36)
        {
            ...
            string body1 = "Dear ,<br/><br/>" + "You have sent request to change Account level from " + arg[1] + " to " + arg[2] + ".";
            body1 = body1 + "<br/<br/> Please confirm through this link; <br/> ";
            body1 = body1 + "<br/><a href='http://beta.munshibaba.com/LevelSwitchApproval.html?token=" + arg[0] + "'> Click Here to Accept </a> <br/>";
            body1 = body1 + "";
            body1 = body1 + "<br/><br/><br/><br/>Regards,<br/><br/><br/>munshi<span style='color:#f49f21;'>baba</span>.com";
            EmailToSomeone(body1, subject, email);
        }
    ...
    public string SendResetRequest(string ResetID, string email)
    {
        ...
        if (cal.Length == 36)
        {
            ...
            body1 = body1 + "<br/><br/><a href='http://beta.munshibaba.com/ConfirmResetApproval.html?token=" + cal + "'> RESET ACCOUNT </a> <br/>";
            body1 = body1 + "";
            body1 = body1 + "<br/><br/><br/><br/>Regards,<br/><br/><br/>munshi<span style='color:#f49f21;'>baba</span>.com";
            EmailToSomeone(body1, subject, email);
        }
