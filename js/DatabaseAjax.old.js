...
function SendEmailNewUser(UserName, CellNo, email) {
    // var mCat, mCol, mIcon;
    var Subj = "Welcome to munshibaba.com; Financial & Management Assistant";
    var Body1 = "Dear Mr. " + UserName + ", <br/>";
    Body1 = Body1 + "You are welcome to munshibaba Financial & Management Assistant"; 
...
function SendEmailInvitation(UserName, CellNo, email) {
    ...
    var Subj = "Welcome to munshibaba.com; Financial & Management Assistant";
    var Body1 = "Dear Mr. " + UserName + ", <br/>";
    Body1 = Body1 + " You are to munshibaba.com; Financial & Management Assistant";
...
function SendEmailShareAccount(UserName, CellNo, email,AccountID,AccountName,Permission,EmailOption,URL1,SenderName,CountryID) {
    // var mCat, mCol, mIcon;
    //alert("a9");
    ...
    //Body1 = Body1 + "</div>";
    //alert("{'UserName':'" + UserName + "','CellNo':'" + CellNo + "','Email':'" + email + "','AccountID':'" + AccountID + "','AccountName':'" + AccountName + "','Permission':'" + Permission + "','EmailOption':'" + EmailOption + "','URL':'" + URL1 + "','SenderName':'" + SenderName + "','CountryID':'" + CountryID + "'}");
    ...
    $.ajax({
        ...
        data: "{'UserName':'" + UserName + "','CellNo':'" + CellNo + "','Email':'" + email + "','AccountID':'" + AccountID + "','AccountName':'" + AccountName + "','Permission':'" + Permission + "','EmailOption':'" + EmailOption + "','URL':'" + URL1 + "','SenderName':'" + SenderName + "','CountryID':'" + CountryID + "','SenderID':'" + usrID +"'}",
        success: function (response) {
